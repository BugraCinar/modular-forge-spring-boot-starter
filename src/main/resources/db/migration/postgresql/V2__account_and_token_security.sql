...
ALTER TABLE admin_activity_log ALTER COLUMN details TYPE TEXT USING details::text;
ALTER TABLE user_activity_log ALTER COLUMN details TYPE TEXT USING details::text;
