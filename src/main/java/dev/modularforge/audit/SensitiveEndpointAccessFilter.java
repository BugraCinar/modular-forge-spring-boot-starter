...
public class SensitiveEndpointAccessFilter extends OncePerRequestFilter {
    ...
    private dev.modularforge.audit.SensitiveEndpointAccessLog.SeverityLevel getSeverityLevel(String severity) {
        return switch (severity.toUpperCase()) {
            case "CRITICAL" -> dev.modularforge.audit.SensitiveEndpointAccessLog.SeverityLevel.CRITICAL;
            case "HIGH" -> dev.modularforge.audit.SensitiveEndpointAccessLog.SeverityLevel.HIGH;
            case "MEDIUM" -> dev.modularforge.audit.SensitiveEndpointAccessLog.SeverityLevel.MEDIUM;
            default -> dev.modularforge.audit.SensitiveEndpointAccessLog.SeverityLevel.LOW;
        };
    }
