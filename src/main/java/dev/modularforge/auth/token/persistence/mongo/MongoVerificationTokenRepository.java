...
public interface MongoVerificationTokenRepository extends VerificationTokenRepository, org.springframework.data.mongodb.repository.MongoRepository<VerificationToken, Long> {
