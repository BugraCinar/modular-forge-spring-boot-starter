...
import dev.modulithforge.storage.r2.UserImageController;
...
@WebMvcTest(value = UserImageController.class, properties = {
        "app.modules.image-storage.enabled=true",
        "app.modules.user-profile.enabled=true"
})
