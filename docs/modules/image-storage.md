...
Id `image-storage`; package `dev.modulithforge.storage.r2`; default off; toggle `app.modules.image-storage.enabled`.
...
3. Delete `src/main/java/dev/modulithforge/storage/r2` and its tests.
